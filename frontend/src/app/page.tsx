...
export default function EntrancePage() {
  ...
  return (
    ...
    >
      ...
      />
      <div className="z-10 w-full max-w-md bg-[#0c1222]/80 backdrop-blur-2xl border border-[#1a2440]/80 p-8 rounded-3xl shadow-2xl relative overflow-hidden transition-all duration-500">
        ...
        <div className="text-center mb-6 flex flex-col items-center">
          ...
          <div className="inline-block mt-2 text-[10px] bg-accent/15 border border-accent/30 text-accent font-bold px-3 py-0.5 rounded-full uppercase tracking-widest">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label htmlFor="username" className="block text-[11px] uppercase tracking-wider text-accent font-extrabold mb-2">
            ...
            <input
              ...
              className="w-full px-4 py-2.5 bg-[#070b18] border border-[#1a2440] rounded-xl text-[#f0f2f8] placeholder-[#7b8aaa] focus:outline-none focus:border-accent transition-all text-sm font-mono"
              required
            />
          </div>

          <div>
            <label htmlFor="password" className="block text-[11px] uppercase tracking-wider text-accent font-extrabold mb-2">
